<template>
    <ul>
        ...
        <li class="col-md-4 col-6" v-for="item in useMaterialStore().materialList"
            @click="useMaterialStore().showItem(item)"
            v-show="item.name.includes(useMaterialStore().search_input) &&
