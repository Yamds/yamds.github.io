            ...
            <transition name="fade" mode="out-in">
                <table v-if="item.name?.length > 0" :key="useMaterialStore().version[item_index]">
                    <tbody>
                        ...
                        <!-- 8~12. 星级具体数值 -->
                        <tr class="level-attr" v-if="useMaterialStore().getValueType(item_index) == 1"
                            v-for="(star, star_index) in item.star">
                            <td>
                        ...
                        <!-- 8~12. 星级平均数值 -->
                        <tr class="level-attr" v-if="useMaterialStore().getValueType(item_index) == 2"
                            v-for="(star, star_index) in item.star">
                            <td>
                                <span>{{ star_index + 1 }}星</span>
                            </td>
