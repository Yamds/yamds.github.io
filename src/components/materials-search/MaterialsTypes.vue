<template>
    ...
    <div class="row gx-2 gy-2">
        ...
        <div class="col-md-auto col-auto" v-for="level in useMaterialStore().material_level" :key="level.id">
    ...
    <div class="row gx-2 gy-2">
        ...
        <div class="col-md-auto col-auto" v-for="type in useMaterialStore().material_type" :key="type.id">
    ...
    <div class="row gx-2 gy-2">
        ...
        <div class="col-md-auto col-auto" v-for="attribute in useMaterialStore().material_attribute"
            :key="attribute.id">
